...
namespace PhysicsCharacterController
{
    ...
    public class NewInputBackend : IInputBackend
    {
        ...
        public bool GetScale() => actions.Gameplay.Scale.IsPressed();
        public Vector2 GetScaleDirections() => actions.Gameplay.ScaleDirections.ReadValue<Vector2>();
    ...
    public class OldInputBackend : IInputBackend
    {
        ...
        public bool GetScale() => Input.GetKey(KeyCode.F);
        public Vector2 GetScaleDirections() => new Vector2(Input.GetAxisRaw("Horizontal"), Input.GetAxisRaw("Vertical"));
    ...
    public class InputReader : MonoBehaviour
    {
        ...
        [HideInInspector] public Vector2 scaleDirections;
        ...
        private void Update()
        {
            ...
            if (enableScale)
            {
                scale = backend.GetScale();
                scaleDirections = backend.GetScaleDirections();
            }
            else
            {
                scale = false;
                scaleDirections = Vector2.zero;
            }
